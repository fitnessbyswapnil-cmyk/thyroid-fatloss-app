  ...
  return (
    <div className="relative overflow-hidden px-6" style={{ paddingTop: "calc(52px + env(safe-area-inset-top, 0px))", paddingBottom: 8 }}>
      ...
      <div className="relative max-w-2xl mx-auto" style={{ zIndex: 1 }}>
        ...
        <h1 className="mt-1.5" style={{ fontFamily: "'Newsreader', Georgia, serif", fontStyle: "italic", fontSize: 31, lineHeight: 1.15, color: "#1c1d20" }}>
          {greeting}, {name}
        </h1>
        ...
        {hasMed ? (
          <div className="flex items-center gap-3 mt-5 p-3.5 rounded-2xl" style={{ background: "#ffffff", border: "1px solid #e2dbcd" }}>
          ...
          <Link href="/dashboard/health" className="flex items-center gap-3 mt-5 p-3.5 rounded-2xl" style={{ background: "#ffffff", border: "1px dashed #cfc7b6" }}>
        ...
        {/* Today's focus */}
        <Link href="/dashboard/plans" className="block relative overflow-hidden mt-3.5 p-5 rounded-3xl" style={{ background: "#ffffff", border: "1px solid rgba(21, 94, 86,0.16)" }}>
          ...
          <div className="relative" style={{ zIndex: 1 }}>
            ...
            <p className="mt-1.5" style={{ fontFamily: "'Newsreader', Georgia, serif", fontStyle: "italic", fontSize: 24, color: "#1c1d20" }}>
              {!todayFocus?.hasPlan
                ? "Your training plan"
        ...
        <div className="grid grid-cols-2 gap-3 mt-3">
          <div className="p-4 rounded-2xl" style={{ background: "#ffffff", border: "1px solid #e2dbcd" }}>
            <p className="text-[10.5px] uppercase font-semibold" style={{ color: "#8b867c", letterSpacing: "0.16em" }}>Check-in streak</p>
            <div className="flex items-baseline gap-1.5 mt-2">
              <span style={{ fontFamily: "'Newsreader', Georgia, serif", fontStyle: "italic", fontSize: 36, lineHeight: 1, color: "#1c1d20" }}>{streak}</span>
          ...
          <Link href="/dashboard/check-in" className="p-4 rounded-2xl block" style={{ background: "#ffffff", border: "1px solid #e2dbcd" }}>
            <p className="text-[10.5px] uppercase font-semibold" style={{ color: "#8b867c", letterSpacing: "0.16em" }}>Weekly check-in</p>
            <p className="mt-2" style={{ fontFamily: "'Newsreader', Georgia, serif", fontStyle: "italic", fontSize: 22, color: "#1c1d20" }}>Week {programWeek}</p>
        ...
        <div className="grid grid-cols-4 gap-2.5">
          {[
            ...
            <Link key={a.label} href={a.href} className="flex flex-col items-center gap-1.5 rounded-2xl py-3.5" style={{ background: "#ffffff", border: "1px solid #e2dbcd" }}>
