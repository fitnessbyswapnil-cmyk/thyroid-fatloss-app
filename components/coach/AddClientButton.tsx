          ...
          >
            ...
            >
              <div className="flex items-center justify-between mb-5">
                <h3 className="font-semibold" style={{ color: "#e8eaf0" }}>Add a client</h3>
              ...
              {done ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-sm" style={{ color: "#c9cdd5" }}>Invite sent. They'll get a magic link to set up their account.</p>
                </div>
              ) : (
                <>
                  <p className="text-xs mb-5" style={{ color: "#7e8a9e" }}>
                  ...
                  <motion.button
                    ...
                    style={{ background: "linear-gradient(135deg, #2dd4bf 0%, #22c55e 100%)", color: "#0a0d14", opacity: !email.trim() ? 0.5 : 1 }}
                  >
